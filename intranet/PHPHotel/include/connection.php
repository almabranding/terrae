...
function __autoload($class_name){
	if($class_name == 'PHPMailer'){
		require_once(dirname(__FILE__).'/modules/phpmailer/class.phpmailer.php');
	}else if($class_name == 'tFPDF'){
		require_once(dirname(__FILE__).'/modules/tfpdf/tfpdf.php');
	}else if(file_exists(dirname(__FILE__).'/classes/'.$class_name.'.class.php')){
		require_once(dirname(__FILE__).'/classes/'.$class_name.'.class.php');
        }else{
            require_once(dirname(__FILE__).'/../libs/'.$class_name.'.php');
        }	
}
