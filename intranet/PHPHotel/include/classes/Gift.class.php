...
class Gift extends MicroGrid {
	...
	{		
		$sql = 'SELECT * FROM gift g JOIN gift_description gd ON g.id=gd.gift_id AND gd.language_id = \''.Application::Get('lang').'\' ORDER BY g.position ASC ';			
