...
if($objLogin->IsLoggedInAs('owner','mainadmin') && Modules::IsModuleInstalled('booking')){
	...
	$objRoomFacilities = new RoomFacilities(1);
	...
	// Start main content
	draw_title_bar(prepare_breadcrumbs(array(_HOTELS_MANAGEMENT=>'',_SETTINGS=>'','Experience Facilities Management'=>'',ucfirst($action)=>'')));
