	...
	{	
		...
		if($this->IsLoggedInAsAdmin()){
			...
			draw_block_bottom();
                        ...
                        draw_block_top(_EXPERIENCES_MANAGEMENT, $menu_index++); 
				echo '<div class="menu_category">';
					if($this->IsLoggedInAs('owner','mainadmin')){
						echo '<label>'._SETTINGS.'</label>';
						echo '<ul>';
						echo '<li>'.$this->PrepareLink('mod_experience_facilities', _EXPERIENCES_FACILITIES).'</li>';
						echo '</ul>';
					}
					
					echo '<label>'._EXPERIENCES.'</label>';
					echo '<ul>';
					echo '<li>'.$this->PrepareLink('experience_info', _EXPERIENCES_INFO, '', '', array('hotels_locations')).'</li>';
					...
					//if($this->IsLoggedInAs('owner','mainadmin')) echo '<li>'.$this->PrepareLink('mod_rooms_settings', _EXPERIENCES_SETTINGS).'</li>';
					if($this->IsLoggedInAs('owner','mainadmin') || ($this->IsLoggedInAs('hotelowner') && $this->HasPrivileges('edit_hotel_rooms'))) echo '<li>'.$this->PrepareLink('mod_experience_management', _EXPERIENCES_MANAGEMENT).'</li>';
					echo '</ul>';
				echo '</div>';						
			draw_block_bottom();			
