...
class Hotels extends MicroGrid {
    ...
    function __construct() {
        ...
        $arr_type = array('1' => 'Rural', '2' => 'Agriculture', '3' => 'Historical', '4' => 'Top');
        ...
        $this->VIEW_MODE_SQL = 'SELECT
								...
								';
        $this->WHERE_CLAUSE.=' AND ' . $this->tableName . '.type=0';
        ...
        $this->EDIT_MODE_SQL = 'SELECT
								...
								' . $this->tableName . '.map_image_thumb,
								' . $this->tableName . '.map_code,
								' . $this->tableName . '.type,
    ...
    public static function DrawAboutUs($draw = true) {
        ...
        $sql = 'SELECT
				...
				WHERE h.is_default = 1 AND hd.language_id = \'' . $lang . '\' AND h.type=0';
    ...
    public static function HotelsCount() {
        $sql = 'SELECT COUNT(*) as cnt FROM ' . TABLE_HOTELS . ' WHERE is_active = 1 AND type=0';
        $result = database_query($sql, DATA_AND_ROWS, FIRST_ROW_ONLY);
        if ($result[1] > 0) {
